<template>
  <nav :class="`nav navbar navbar-expand-xl navbar-light iq-navbar ${headerNavbar}`">
    ...
    <div :class="`container-fluid navbar-inner ${customNavbarInner === true ? 'custom-navbar-inner2' : 'custom-navbar-inner'}`">
      <slot></slot>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="mb-2 navbar-nav ms-auto align-items-center mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="p-0 sub-drop dropdown-menu dropdown-menu-end custom-margin" aria-labelledby="dropdownMenuButton2">
                ...
                <b-card-body class="p-0">
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/01.png" alt="" />
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <div class="">
                        <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/02.png" alt="" />
                      </div>
                      <div class="ms-3 w-100">
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/03.png" alt="" />
                      <div class="ms-3 w-100">
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/04.png" alt="" />
              ...
              <b-card no-body class="m-0 shadow-none">
                ...
                <b-card-body class="p-0">
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <div class="">
                        <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/05.png" alt="" />
                      </div>
                      <div class="ms-3">
