      ...
      <b-col lg="3">
        <b-card no-body>
          <b-card-body>
            ...
            <div class="text-center">
              <h2>
                <Vue3autocounter ref="counter" :startAmount="0" :endAmount="96.6" suffix="K" decimals="1" />
              </h2>
              <div>
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 20 20" fill="currentColor">
      ...
      <b-col lg="3">
        <b-card no-body>
          <b-card-body>
            ...
            <div class="text-center">
              <h2>
                <Vue3autocounter ref="counter" :startAmount="0" :endAmount="15.5" decimals="1" suffix="K" />
              </h2>
              <div>
      ...
      <b-col lg="3">
        <b-card>
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h6>
              <b>
                <Vue3autocounter ref="counter" :startAmount="0" :endAmount="18378" prefix="$" />
              </b>
            </h6>
            <apexchart height="60" width="100" type="area" :series="box1.series" :options="box1.options" />
      ...
      <b-col lg="3">
        <b-card>
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h6>
              <b>
                <Vue3autocounter ref="counter" :startAmount="0" :endAmount="190" prefix="$" />
              </b>
            </h6>
            <apexchart height="60" width="100" type="area" :series="box2.series" :options="box2.options" />
      ...
      <b-col lg="3">
        <b-card>
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h6>
              <b>
                <Vue3autocounter ref="counter" :startAmount="0" :endAmount="45" />
              </b>
            </h6>
            <apexchart height="60" width="100" type="area" :series="box3.series" :options="box3.options" />
        ...
        <b-card>
          ...
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <h6>
                <b>
                  <Vue3autocounter ref="counter" :startAmount="0" :endAmount="60" />
                </b>
              </h6>
            </div>
            <apexchart height="60" width="100" type="area" :series="box4.series" :options="box4.options" />
        ...
        <b-card>
          ...
          <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
              ...
              <h2>
                <Vue3autocounter ref="counter" :startAmount="0" :endAmount="352" />
              </h2>
            </div>
            <div class="pt-3">
        ...
        <b-card>
          ...
          <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
              ...
              <h2>
                <Vue3autocounter ref="counter" prefix="$" :startAmount="0" :endAmount="37" suffix="K" />
              </h2>
            </div>
            <div class="pt-3">
      ...
      <b-col class="col-lg-12 row m-0 p-0 iq-duration-block">
        <b-col sm="6" md="6" lg="2">
          <b-card>
            ...
            <apexchart height="60" type="area" :series="ethernet1.series" :options="ethernet1.options" />
          </b-card>
        </b-col>
        <b-col sm="6" md="6" lg="2">
          <b-card>
            ...
            <apexchart height="60" type="area" :series="ethernet2.series" :options="ethernet2.options" />
          </b-card>
        </b-col>
        <b-col sm="6" md="6" lg="2">
          <b-card>
            ...
            <apexchart height="60" type="area" :series="ethernet3.series" :options="ethernet3.options" />
          </b-card>
        </b-col>
        <b-col sm="6" md="6" lg="2">
          <b-card>
            ...
            <apexchart height="60" type="area" :series="ethernet4.series" :options="ethernet4.options" />
          </b-card>
        </b-col>
        <div class="col-md-12 col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <apexchart height="65" width="140" type="area" :series="chart9.series" :options="chart9.options" />
            </div>
          </div>
        </div>
      </b-col>
        ...
        <b-card no-body>
          ...
          <b-card-body>
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
              ...
              <b-button tag="button" variant="outline-danger" size="sm">
