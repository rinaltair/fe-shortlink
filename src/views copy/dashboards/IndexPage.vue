              ...
              <b-card-body>
                <div class="progress-widget">
                  <analytics-widget :index="index" :title="item.title" :size="item.size" :sub-title="item.subTitle" :value="item.value" :color="item.color" :is-profit="item.isProfit">
                    <svg class="card-slie-arrow" width="24" height="24px" viewBox="0 0 24 24" v-if="item.arrow != 'up'">
                  ...
                  <div class="progress-detail">
                    ...
                    <h4 class="counter">
                      <Vue3Autocounter :endAmount="item.amount" :prefix="item.prefix" :suffix="item.suffix" :separator="item.separator" :decimals="item.decimal"> </Vue3Autocounter>
                    </h4>
                  </div>
                </div>
              </b-card-body>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xl-6">
          <div class="card" data-aos="fade-up" data-aos-delay="1000">
            ...
            <div class="card-body" style="padding-bottom: 1.3rem">
              <div class="d-flex flex-wrap align-items-center justify-content-between">
                <apexchart :height="230" type="radialBar" class="col-md-8 col-lg-8 mb-4" id="myChart1" :options="earningChart.options" :series="earningChart.series" />
                ...
                <table id="basic-table" class="table mb-0 table-striped" role="grid">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="iq-media-group iq-media-group-1">
                          <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">SP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">PP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">MM</div> </a>{{ ' ' }}
                        </div>
                      </td>
                      <td>$14,000</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="iq-media-group iq-media-group-1">
                          <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">SP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">PP</div> </a>{{ ' ' }}
                        </div>
                      </td>
                      <td>$30,000</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="iq-media-group iq-media-group-1">
                          <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">PP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">TP</div> </a>{{ ' ' }}
                        </div>
                      </td>
                      <td>$8,500</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="iq-media-group iq-media-group-1">
                          <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">SP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">PP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">MM</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">TP</div> </a>{{ ' ' }}
                        </div>
                      </td>
                      <td>$20,500</td>
                      <td>
        ...
        <div class="col-md-12 col-lg-12" data-aos="fade-up" data-aos-delay="800">
          <div class="card credit-card-widget" data-aos="fade-up" data-aos-delay="700">
            <div class="card-header pb-4 border-0">
              <div class="p-4 primary-gradient-card rounded">
                ...
                <div class="my-4">
                  <div class="card-number"><span class="fs-5 me-2">5789</span>{{ ' ' }} <span class="fs-5 me-2">****</span>{{ ' ' }} <span class="fs-5 me-2">****</span>{{ ' ' }} <span class="fs-5">2847</span>{{ ' ' }}</div>
                </div>
