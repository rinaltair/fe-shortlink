<template>
  <tr v-for="(item, index) in list" :key="index">
    <td class="text-center"><img class="bg-primary-subtle rounded img-fluid avatar-40 me-3" :src="item.image" alt="profile" loading="lazy" /></td>
    <td>{{ item.name }}</td>
    <td>{{ item.contact }}</td>
    <td>{{ item.email }}</td>
    <td>{{ item.country }}</td>
    ...
    <td>
      <div class="flex align-items-center list-user-action">
        ...
        >{{ ' ' }}
        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="#">
          <span class="btn-inner">
            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        >{{ ' ' }}
        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete" href="#">
          <span class="btn-inner">
