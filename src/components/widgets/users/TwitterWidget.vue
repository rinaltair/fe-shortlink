      ...
      <div v-for="(item, index) in list" :key="index">
        <div class="twit-feed">
          <div class="d-flex align-items-center mb-2">
            <img :class="`rounded-pill img-fluid avatar-50 me-3 p-1 bg-${item.background}-subtle ${item.padding} `" :src="item.image" loading="lazy" />
        ...
        <hr class="my-4" v-if="index !== list.length - 1" />
      </div>
    </b-card-body>
  </b-card>
</template>
