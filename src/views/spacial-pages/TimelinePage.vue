              ...
              <li>
                ...
                <div class="d-inline-block w-100">
                  ...
                  <div class="iq-media-group iq-media-group-1">
                    <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">SP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">PP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">MM</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">SP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">PP</div> </a>{{ ' ' }} <a href="#" class="iq-media-1"> <div class="icon iq-icon-box-3 rounded-pill">MM</div> </a>{{ ' ' }}
                  </div>
                </div>
              </li>
              <li>
