<template>
  ...
  <footer :class="`footer ${footerStyle}`">
    <div class="footer-body">
      <ul class="left-panel list-inline mb-0 p-0">
        <li class="list-inline-item custom-inline"><router-link :to="{ name: 'default.privacy-policy' }">Privacy Policy</router-link></li>
        {{
          ' '
        }}
  ...
  <!-- Footer Section End -->
  <b-offcanvas v-model="shareOffcanvas" placement="bottom" title="Share">
...
export default {
  ...
  setup() {
    ...
    const footerStyle = computed(() => store.footer_style)
