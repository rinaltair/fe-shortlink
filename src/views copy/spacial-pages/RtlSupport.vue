          ...
          <div class="card aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
            <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end custom-dropdown-rtlsupport" aria-labelledby="dropdownMenuButton22">
          ...
          <div class="card" data-aos="fade-up" data-aos-delay="1000">
            <div class="card-header d-flex justify-content-between flex-wrap">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end custom-dropdown-rtlsupport" aria-labelledby="dropdownMenuButton1">
                  <li><a class="dropdown-item" href="#">This Week</a></li>
                  <li><a class="dropdown-item" href="#">This Month</a></li>
                  <li><a class="dropdown-item" href="#">This Year</a></li>
                </ul>
            ...
            <div class="card-body" :height="277.99">
          ...
          <div class="card" data-aos="fade-up" data-aos-delay="1200">
            <div class="card-header d-flex justify-content-between flex-wrap">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end custom-dropdown-rtlsupport" aria-labelledby="dropdownMenuButton3">
                  <li><a class="dropdown-item" href="#">This Week</a></li>
                  <li><a class="dropdown-item" href="#">This Month</a></li>
                  <li><a class="dropdown-item" href="#">This Year</a></li>
                </ul>
            ...
            <div class="card-body" :height="277.99">
              <apexchart :height="215" type="bar" class="dactivity1" id="dactivity1" :options="conversionChart.options" :series="conversionChart.series" />
            </div>
          </div>
        </div>
          ...
          <div class="card credit-card-widget" data-aos="fade-up" data-aos-delay="900">
            ...
            <div class="card-body">
              ...
              <div class="d-grid grid-cols-2 gap">
                ...
                <button class="btn btn-secondary text-uppercase p-2">ANALYTICS</button>
              </div>
            </div>
          </div>
...
export default {
  ...
  setup() {
    ...
    const themeSchemeDirection = store.theme_scheme_direction_value
    ...
    onUnmounted(() => {
      store.theme_scheme_direction(themeSchemeDirection)
    })
