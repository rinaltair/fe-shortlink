<template>
  <div class="bd-example">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="mb-2 navbar-nav me-auto mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu custom-popper" aria-labelledby="navbarDropdown1">
    ...
    <nav class="mt-5 navbar navbar-expand-lg navbar-dark bg-primary rounded">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Logo</a>
        ...
        <div class="collapse navbar-collapse" id="navbar-1">
          <ul class="mb-2 navbar-nav ms-auto mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu custom-popper" aria-labelledby="navbarDropdown2">
                <li><a class="dropdown-item" href="#">Action</a></li>
                <li><a class="dropdown-item" href="#">Another action</a></li>
                <li class="px-3">
                  <hr class="dropdown-divider" />
    ...
    <nav class="mt-5 navbar navbar-expand-lg navbar-dark bg-danger rounded">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Logo</a>
