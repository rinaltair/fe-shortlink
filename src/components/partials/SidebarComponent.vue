  ...
  <default-sidebar>
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
      ...
      <side-menu title="Design System" icon="wallet" :route="{ to: 'design-system.main' }">
        <template #title> Design System<b-badge variant="success" pill class="item-name">UI</b-badge> </template>
      </side-menu>
      <li>
        <hr class="hr-horizontal" />
      </li>
      <side-menu title="Pages" :static-item="true"></side-menu>
      <side-menu title="Special Pages" icon="controller" toggle-id="special-pages" :caret-icon="true" :route="{ popup: 'false', to: 'special-pages' }" @onClick="toggle" :active="currentRoute.includes('special-pages')">
        <b-collapse tag="ul" class="sub-nav" id="special-pages" accordion="sidebar-menu" :visible="currentRoute.includes('special-pages')">
          ...
          <side-menu isTag="router-link" title="Calendar" icon="circle" :icon-size="10" icon-type="solid" miniTitle="C" :route="{ to: 'default.calender' }"></side-menu>
      ...
      <side-menu title="Users" icon="user-group" toggle-id="users" :caret-icon="true" :route="{ popup: 'false', to: 'user' }" @onClick="toggle" :active="currentRoute.includes('user')">
        <b-collapse tag="ul" class="sub-nav" id="users" accordion="sidebar-menu" :visible="currentRoute.includes('user')">
          ...
          <side-menu isTag="router-link" title="Add User" icon="circle" :icon-size="10" icon-type="solid" miniTitle="UA" :route="{ to: 'default.user-add' }"></side-menu>
      ...
      <side-menu title="Components" icon="brief-case" :route="{ to: 'design-system.main' }"></side-menu>
      <side-menu title="Widget" icon="offer" toggle-id="widgets" :caret-icon="true" :route="{ popup: 'false', to: 'widget' }" @onClick="toggle" :active="currentRoute.includes('widget')">
        <b-collapse tag="ul" class="sub-nav" id="widgets" accordion="sidebar-menu" :visible="currentRoute.includes('widget')">
          <side-menu isTag="router-link" title="Widget Basic" icon="circle" :icon-size="10" icon-type="solid" miniTitle="WB" :route="{ to: 'default.widget-basic' }"></side-menu>
          <side-menu isTag="router-link" title="Widget Chart" icon="circle" :icon-size="10" icon-type="solid" miniTitle="WC" :route="{ to: 'default.widget-chart' }"></side-menu>
          <side-menu isTag="router-link" title="Widget Card" icon="circle" :icon-size="10" icon-type="solid" miniTitle="WC" :route="{ to: 'default.widget-card' }"></side-menu>
        </b-collapse>
      </side-menu>
      ...
      <side-menu class="mb-5" title="Icons" icon="i" toggle-id="icons" :caret-icon="true" :route="{ popup: 'false', to: 'icons' }" @onClick="toggle" :active="currentRoute.includes('icons')">
