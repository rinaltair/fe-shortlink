<template>
          ...
          <div class="comment-area mt-3">
            ...
            <form class="form" action="#">
              <div class="input-group mb-3">
                ...
                <b-button tag="button" variant="primary" id="basic-addon2">
        ...
        <b-card no-body>
          ...
          <b-card-body>
            <div class="d-grid gap-card grid-cols-3">
              <a data-fslightbox="gallery" v-for="(item, index) in gallery" :key="index" @click="toggler = !toggler">
                <img :src="item.img" alt="profile-image" :class="`img-fluid bg-${item.color}-subtle rounded`" loading="lazy" />
              </a>
            </div>
          </b-card-body>
        </b-card>
        ...
        <b-card no-body>
          ...
          <b-card-body>
            <ul class="list-inline m-0 p-0">
              <li v-for="(item, index) in listItems" :key="index" :class="`d-flex ${item.suggestionMarginBottom} align-items-center`">
                <div :class="`img-fluid ${item.bgClass} rounded-pill`">
                  <img :src="require(`@/assets/images/icons/${item.imgSrc}`)" alt="story-img" class="rounded-pill avatar-40" loading="lazy" />
                </div>
                <div class="ms-3 flex-grow-1">
                  <h6>{{ item.name }}</h6>
                  <p class="mb-0">{{ item.mutualFriends }} mutual friends</p>
                </div>
  ...
  <FsLightbox :toggler="toggler" :sources="[require('@/assets/images/icons/04.png'), require('@/assets/images/shapes/02.png'), require('@/assets/images/icons/08.png'), require('@/assets/images/shapes/04.png'), require('@/assets/images/icons/02.png'), require('@/assets/images/shapes/06.png'), require('@/assets/images/icons/05.png'), require('@/assets/images/shapes/04.png'), require('@/assets/images/icons/01.png')]" />
</template>
<script>
import { ref } from 'vue'
...
export default {
  ...
  data() {
    const gallery = ref([
      { img: require('@/assets/images/icons/04.png'), color: 'info' },
      { img: require('@/assets/images/shapes/02.png'), color: 'primary' },
      { img: require('@/assets/images/icons/08.png'), color: 'info' },
      { img: require('@/assets/images/shapes/04.png'), color: 'primary' },
      { img: require('@/assets/images/icons/02.png'), color: 'warning' },
      { img: require('@/assets/images/shapes/06.png'), color: 'primary' },
      { img: require('@/assets/images/icons/05.png'), color: 'danger' },
      { img: require('@/assets/images/shapes/04.png'), color: 'primary' },
      { img: require('@/assets/images/icons/01.png'), color: 'success' }
    ])
    return {
      gallery,
      toggler: false,
