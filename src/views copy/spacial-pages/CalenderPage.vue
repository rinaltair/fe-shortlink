          ...
          <b-row>
            <b-col cols="12">
              ...
              <b-row class="g-3 align-items-center form-group">
                ...
                <b-col cols="10">
                  <flat-picker v-model="date" class="form-control" :config="dateOption"
                    placeholder="24 Jan 2022 to 23 Feb 2022"></flat-picker>
                </b-col>
              </b-row>
              <b-row class="g-3 align-items-center form-group">
                <b-col cols="2">
...
const events = ref([
  ...
  },
  {
    ...
    start: moment(new Date(), 'YYYY-MM-DD').add(-14, 'days').format('YYYY-MM-DD'),
    color: '#047685',
