<template>
    ...
    <b-col sm="12">
      <b-card no-body class="card">
        <div class="card-header d-flex justify-content-between flex-wrap">
          ...
          <div class="">
            <a href="#" class="text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3" data-bs-toggle="modal" data-bs-target="#new-permission">
              <i class="btn-inner">
              ...
              New Permission </a
            >{{ ' ' }}
            <a href="#" class="text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3" data-bs-toggle="modal" data-bs-target="#new-role">
              <i class="btn-inner">
                <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                </svg>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr class="" v-for="(permission, index) in permissions" :key="index">
                  ...
                  <td v-for="(role, index1) in roles" :key="index1" class="text-center">
                    <input class="form-check-input" type="checkbox" checked v-if="role.status[index] === 'true' && permission.status === 'true'" />
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropPermissionLabel">Add New Permission</h5>
  ...
  <div class="modal fade" id="new-role" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropRoleLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropRoleLabel">Add New Role</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="form-group">
  ...
  data() {
    return {
      roles: [
        {
          title: 'ADMIN',
          status: ['false', 'false', 'false', 'true', 'true', 'false']
        },
        {
          title: 'DEMO ADMIN',
          status: ['false', 'true', 'false', 'true', 'true', 'false']
        },
        {
          title: 'USER',
          status: ['false', 'true', 'false', 'true', 'true', 'false']
