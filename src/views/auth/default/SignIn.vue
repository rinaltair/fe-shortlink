    ...
    <b-row class="m-0 align-items-center bg-white vh-100">
      <b-col md="6">
        <b-row class="justify-content-center">
          <b-col md="10">
            <b-card class="card-transparent shadow-none d-flex justify-content-center mb-0 auth-card iq-auth-form" body-class="z-3 px-md-0 px-lg-4">
              ...
              <form>
                ...
                <p class="mt-3 text-center">Don’t have an account? <router-link :to="'/auth/register'" class="text-underline">Click here to sign up.</router-link></p>
              </form>
            </b-card>
          </b-col>
        </b-row>
