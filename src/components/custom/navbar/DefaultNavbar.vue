<template>
  <nav :class="`nav navbar navbar-expand-xl navbar-light iq-navbar ${headerNavbar}`">
    ...
    <div
      :class="`container-fluid navbar-inner ${customNavbarInner === true ? 'custom-navbar-inner2' : 'custom-navbar-inner'}`">
      <slot></slot>
        ...
        <ul class="mb-2 navbar-nav ms-auto align-items-center mb-lg-0">
          <li class="me-0 me-xl-2" v-if="isGoPro">
            <a class="btn btn-primary btn-sm d-flex gap-2 align-items-center" aria-current="page"
              ...
              target="_blank">
              <icon-component type="solid" :size="16" icon-name="location-arrow"></icon-component>
              Go Pro
            </a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="p-0 sub-drop dropdown-menu dropdown-menu-end custom-margin"
              aria-labelledby="dropdownMenuButton2">
              <b-card no-body class="m-0 border-0 shadow-none">
                <div class="p-0">
                  <ul class="list-group list-group-flush p-0">
                    <li class="iq-sub-card list-group-item">
                      <a class="p-0" href="#"><img src="@/assets/images/Flag/flag-03.png" alt="img-flaf"
                          class="img-fluid me-2" style="width: 15px; height: 15px; min-width: 15px" />Spanish</a>
                    </li>
                    <li class="iq-sub-card list-group-item">
                      <a class="p-0" href="#"><img src="@/assets/images/Flag/flag-04.png" alt="img-flaf"
                          class="img-fluid me-2" style="width: 15px; height: 15px; min-width: 15px" />Italian</a>
                    </li>
                    <li class="iq-sub-card list-group-item">
                      <a class="p-0" href="#"><img src="@/assets/images/Flag/flag-02.png" alt="img-flaf"
                          class="img-fluid me-2" style="width: 15px; height: 15px; min-width: 15px" />French</a>
                    </li>
                    <li class="iq-sub-card list-group-item">
                      <a class="p-0" href="#"><img src="@/assets/images/Flag/flag-05.png" alt="img-flaf"
                          class="img-fluid me-2" style="width: 15px; height: 15px; min-width: 15px" />German</a>
                    </li>
                    <li class="iq-sub-card list-group-item">
                      <a class="p-0" href="#"><img src="@/assets/images/Flag/flag-06.png" alt="img-flaf"
                          class="img-fluid me-2" style="width: 15px; height: 15px; min-width: 15px" />Japanese</a>
                    </li>
                  </ul>
                </div>
              </b-card>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="p-0 sub-drop dropdown-menu dropdown-menu-end custom-margin" aria-labelledby="notification-drop">
                ...
                <b-card-body class="p-0">
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/01.png"
                        alt="" />
                      <div class="ms-3 w-100">
                        <h6 class="mb-0 text-start">Emma Watson Bni</h6>
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <div class="">
                        <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/02.png"
                          alt="" />
                      </div>
                      <div class="ms-3 w-100">
                        <h6 class="mb-0 text-start">New customer is join</h6>
                        <div class="d-flex justify-content-between align-items-center">
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/03.png"
                        alt="" />
                      <div class="ms-3 w-100">
                        <h6 class="mb-0 text-start">Two customer is left</h6>
                        <div class="d-flex justify-content-between align-items-center">
                          <p class="mb-0">Cyst Bni</p>
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/04.png"
                        alt="" />
                      <div class="w-100 ms-3">
                        <h6 class="mb-0 text-start">New Mail from Fenny</h6>
                        <div class="d-flex justify-content-between align-items-center">
                          <p class="mb-0">Cyst Bni</p>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="p-0 sub-drop dropdown-menu dropdown-menu-end custom-margin" aria-labelledby="mail-drop">
              <b-card no-body class="m-0 shadow-none">
                <div class="py-3 card-header d-flex justify-content-between bg-primary">
                  <b-card-title>
                ...
                <b-card-body class="p-0">
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <div class="">
                        <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="@/assets/images/shapes/05.png"
                          alt="" />
                      </div>
                      <div class="ms-3">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end custom-drop" aria-labelledby="navbarDropdown">
