          ...
          <div class="d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="d-flex align-items-center flex-wrap">
              <div class="dropdown me-3">
                <span class="dropdown-toggle align-items-center d-flex" id="dropdownMenuButton04" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Sort By: </span>
              ...
              <div class="dropdown me-3">
                <span class="dropdown-toggle align-items-center d-flex" id="dropdownMenuButton05" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Group By: Status </span>
              ...
              <div class="dropdown mt-2 mt-md-0">
                <span x-placement="bottom-start" class="dropdown-toggle align-items-center d-flex" id="dropdownMenuButton06" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="position: relative"></span>
    ...
    <b-col lg="3">
      <div class="card-transparent mb-0 desk-info">
        <b-row>
          <b-col cols="12">
            <b-card>
              <title-card title="Open Projects 05" variant="pink"></title-card>
            </b-card>
          </b-col>
          <b-col cols="12">
    ...
    <b-col lg="3">
      <div class="card-transparent mb-0 desk-info">
        <b-row>
          <b-col cols="12">
            <b-card>
              <title-card title="Closed 03" variant="primary"></title-card>
            </b-card>
          </b-col>
          <b-col cols="12">
            <new-task-card></new-task-card>
