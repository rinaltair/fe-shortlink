  ...
  <div class="card">
    ...
    <div class="card-body">
      <ul class="list-inline m-0 p-0">
        <li class="d-flex align-items-center" v-for="(item, index) in list" :key="index" :class="{ 'mb-4': index !== list.length - 1 }">
          <div :class="`img-fluid bg-${item.background}-subtle rounded-pill`"><img :src="item.image" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
