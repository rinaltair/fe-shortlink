<template>
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <img src="../../assets/modules/landing-pages/images/home-2/banner-contact.webp" alt="" class="img-fluid mb-4 pb-3" />
      </div>
      <div class="col-lg-7 col-md-12 text-lg-start text-center pt-lg-2 pt-0">
        <p class="text-primary text-uppercase sub-title mb-2">contact</p>
      ...
      <div class="col-lg-5 contact-detail mt-4 mt-lg-0 pt-lg-2 pt-0">
        <h5 class="mb-4">Themes, E-commerce website, Dashboard and Apps.</h5>
